...
public class Game extends Application {
    ...
    private void initializeTopControls() {
        ...
        buttonStart = new Button("Démarrer le jeu");
        ...
        buttonStart.setOnAction(e -> {
            if (calculator.getPopulation() > 0) {
                ...
                alert.setTitle("La grille est vide");
                alert.setHeaderText(null);
                alert.setContentText("Le jeu nécessite au moins une cellule vivante");
                alert.showAndWait();
            }
        });
        ...
        buttonStep = new Button("Étape suivante");
        buttonStep.setDisable(false);
        ...
        buttonRestore = new Button("Restaurer");
        buttonRestore.setDisable(false);
        ...
        labelGeneration = new Label("Génération " + calculator.getGeneration());
    ...
    private void initializeBottomControls() {
        ...
        Label LabelDefineGrid = new Label("Redéfinir la grille : ");
        LabelDefineGrid.getStyleClass().add("label-information");

        buttonRedefine = new Button("Redimensionner");
    ...
    private void initializeMatrix(int rows, int cols) {
        ...
        for (int i = 0; i < matrix.length; i++)
            for (int j = 0; j < matrix[i].length; j++) {
                ...
                matrix[i][j].setMinWidth(primaryScreenBounds.getWidth() * 0.009);
    ...
    private void updateGeneration() {
        labelGeneration.setText("Génération : " + calculator.getGeneration());
    }
